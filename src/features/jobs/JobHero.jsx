    ...
    <section className="relative pt-20 pb-10 px-6 w-full flex flex-col items-center overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-4xl w-full">
        ...
        <form onSubmit={handleSubmit} className="w-full max-w-3xl mx-auto mb-12 relative group z-20">
          ...
          `}>
            {/* Search Icon */}
            <div className="pl-4 pr-3 text-gray-400 group-focus-within:text-purple-500 transition-colors">
            ...
            <input 
              ...
              className={`
                flex-1 bg-transparent px-2 py-4 outline-none font-medium text-lg
                ${isLight ? "text-gray-900 placeholder-gray-400" : "text-white placeholder-gray-500"}
              `}
            />

            {/* Extraordinary Button with Shimmer */}
            <button type="submit" className="relative overflow-hidden bg-purple-600 hover:bg-purple-700 text-white px-8 py-4 rounded-xl font-bold transition-all transform active:scale-95 shadow-lg group-hover:shadow-purple-500/25">
