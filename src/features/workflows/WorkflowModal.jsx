...
const WorkflowModal = ({ isOpen, onClose, workflowId }) => {
  ...
  return (
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* MODAL CONTAINER - Stable Grid Layout */}
      <div 
        className={`
          relative w-full max-w-2xl rounded-2xl shadow-2xl animate-fade-in-up 
          grid grid-rows-[auto_1fr_auto] h-[650px] max-h-[90vh]
        ...
        <div className="overflow-y-auto p-6 custom-scrollbar relative">
          ...
          {loading ? (
             ...
             <div className="h-full w-full">
                <div className={`
                   w-full h-full p-4 rounded-xl overflow-auto font-mono text-xs whitespace-pre custom-scrollbar
