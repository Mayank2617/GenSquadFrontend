...
const ExpertProfiles = () => {
  ...
  const experts = [
    {
      ...
      skills: ["Fintech", "Figma", "Sql", "Java", "Java", "Java", "Node", "React"],
      description:
        "Results-driven IT professional with over 6 years of experience, specializing in Python development and Machine Learning. Skilled in designing user-centric solutions and scalable systems.",
      badges: [
    ...
    },
    {
      ...
      skills: ["Fintech", "Figma", "Sql", "Java", "Java", "Java", "Node", "React"],
      description:
        "Results-driven IT professional with over 6 years of experience, specializing in Python development Machine Learning. Skilled in designing modern UI systems and advanced interfaces.",
      badges: [
        { icon: "/images/fintech.svg", text: "Fintech", bg: "#f4b840e5" },
        { icon: "/images/iit.svg", text: "IIT", bg: "#13a210" },
      ],
  ...
  return (
    <section
      className={`w-full px-4 sm:px-6  lg:px-[30px]   ${isLight ? "bg-white" : "bg-[#0a0a0a]"
        }`}
    >
      <div className="w-full max-w-[1166px] mx-auto pt-[40px] pb-[40px]">
        {/* HEADER */}
        <div className="flex flex-col justify-start items-center w-full px-[40px] sm:px-[80px]">
          <h2
            className={`text-[25px] sm:text-[38px] md:text-[50px] font-space font-medium text-center ${isLight ? "text-black" : "text-[#f1f1f1]"
              }`}
          >
          ...
          <p
            className={`text-[10px] sm:text-[15px] md:text-[20px] text-center mt-2 ${isLight ? "text-[#6b6b6b]" : "text-[#bababa]"
              }`}
          >
          ...
          {experts.map((expert) => {
            ...
            return (
              ...
              >
                ...
                {/* DESCRIPTION */}
                <p
                  className={`leading-[22px] text-[14px] ${isLight ? "text-[#444]" : "text-[#bababa]"
                    }`}
                >
                  {isDescExpanded
                    ? expert.description
                ...
                {/* BUTTON */}
                <div className="mt-1">
                  <div className="p-[2px] rounded-[10px] bg-gradient-to-r from-[#8b5cf6] to-[#513590] inline-block">
                    <button
                      className={`px-8 py-3 rounded-[8px] text-[16px] flex items-center gap-2
                        ${isLight
                          ? "bg-white text-black"
